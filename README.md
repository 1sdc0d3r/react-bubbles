...
- [ ] Explain what a token is used for.
  <!--! used to store your login so the server knows your authenticated. used in network requests as well -->

- [ ] What steps can you take in your web apps to keep your data secure?
  <!--! use authentication with a header -->
  
- [ ] Describe how web servers work.
  <!--! web servers hold the code on the machine, then from the machine, it sends a request across modems to find the location of the code to return back to the machine. -->
